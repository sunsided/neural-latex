...
\begin{figure}[H]
	...
	\caption[Surface plot of $f(x,y)=(x-y)^2$.]{Surface plot of $f(x,y)=(x-y)^2$. Shows the parameter valley in which the cost function will be minimal.}
	\label{fig:sse_cost_mesh}
\end{figure}

\begin{figure}[H]
	\centering
	\input{images/error_quiver.tikz}
	\caption[Quiver plot of $f(x,y)=(x-y)^2$.]{Gradient vector field for $f(x,y)=(x-y)^2$. Length and direction of the vectors represent magnitude and sign of the partial derivative.}
	\label{fig:sse_cost_quiver}
\end{figure}

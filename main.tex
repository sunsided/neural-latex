...
The \textit{Jacobian} (second derivative) of the squared-error function can be obtained by differentiating \cref{eq:sse1stDerivative}, such that
%
\begin{align}
...
\end{align}
%
meaning that the Jacobian of the squared error cost function is governed by the first and second derivatives of the hypothesis $h_\theta(x)$ (e.g. the network).

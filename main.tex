...
\section{Feedforward and error backpropagation}

\section{Connection weight estimation}
...
\end{align}
%
meaning that the Laplacian of the squared error cost function is governed by the first and second derivatives of the hypothesis $h_\theta(x)$ (e.g. the network).
